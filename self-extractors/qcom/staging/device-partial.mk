...
# Qualcomm blob(s) necessary for Aries hardware
PRODUCT_COPY_FILES := \
    ...
    vendor/qcom/aries/proprietary/mm-audio-send-cal:system/bin/mm-audio-send-cal:qcom \
    ...
    vendor/qcom/aries/proprietary/diag.cfg:system/etc/diag.cfg:qcom \
    vendor/qcom/aries/proprietary/a225_pfp.fw:system/etc/firmware/a225_pfp.fw:qcom \
    vendor/qcom/aries/proprietary/a225_pm4.fw:system/etc/firmware/a225_pm4.fw:qcom \
    vendor/qcom/aries/proprietary/a225p5_pm4.fw:system/etc/firmware/a225p5_pm4.fw:qcom \
    vendor/qcom/aries/proprietary/a300_pfp.fw:system/etc/firmware/a300_pfp.fw:qcom \
    vendor/qcom/aries/proprietary/a300_pm4.fw:system/etc/firmware/a300_pm4.fw:qcom \
    vendor/qcom/aries/proprietary/leia_pfp_470.fw:system/etc/firmware/leia_pfp_470.fw:qcom \
    vendor/qcom/aries/proprietary/leia_pm4_470.fw:system/etc/firmware/leia_pm4_470.fw:qcom \
    ...
    vendor/qcom/aries/proprietary/vidcfw.elf:system/etc/firmware/vidcfw.elf:qcom \
    ...
    vendor/qcom/aries/proprietary/libGLESv2S3D_adreno200.so:system/lib/egl/libGLESv2S3D_adreno200.so:qcom \
    vendor/qcom/aries/proprietary/libGLESv2_adreno200.so:system/lib/egl/libGLESv2_adreno200.so:qcom \
    vendor/qcom/aries/proprietary/libplayback_adreno200.so:system/lib/egl/libplayback_adreno200.so:qcom \
    ...
    vendor/qcom/aries/proprietary/libOmxAacDec.so:system/lib/libOmxAacDec.so:qcom \
    vendor/qcom/aries/proprietary/libOmxWmaDec.so:system/lib/libOmxWmaDec.so:qcom \
    vendor/qcom/aries/proprietary/libOpenCL.so:system/lib/libOpenCL.so:qcom \
    vendor/qcom/aries/proprietary/libOpenVG.so:system/lib/libOpenVG.so:qcom \
    vendor/qcom/aries/proprietary/libQSEEComAPI.so:system/lib/libQSEEComAPI.so:qcom \
    vendor/qcom/aries/proprietary/lib_dlb_msd.so:system/lib/lib_dlb_msd.so:qcom \
    vendor/qcom/aries/proprietary/libacdbloader.so:system/lib/libacdbloader.so:qcom \
    vendor/qcom/aries/proprietary/libalsautils.so:system/lib/libalsautils.so:qcom \
    ...
    vendor/qcom/aries/proprietary/libaudioparsers.so:system/lib/libaudioparsers.so:qcom \
    vendor/qcom/aries/proprietary/libc2d2_a3xx.so:system/lib/libc2d2_a3xx.so:qcom \
    vendor/qcom/aries/proprietary/libc2d2_z180.so:system/lib/libc2d2_z180.so:qcom \
    ...
    vendor/qcom/aries/proprietary/libllvm-arm.so:system/lib/libllvm-arm.so:qcom \
    ...
    vendor/qcom/aries/proprietary/libsc-a2xx.so:system/lib/libsc-a2xx.so:qcom \
